...
**0.171-r3** also fixes startup with Windows DirectX boot settings: the launcher selects Vulkan automatically and backs up the original boot.vcfg. VersionCode: 173.
